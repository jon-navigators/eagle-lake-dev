...
<execution_context>
@/home/user/eagle-lake-dev/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow /home/user/eagle-lake-dev/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
