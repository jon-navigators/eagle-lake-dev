...
<execution_context>
@/home/user/eagle-lake-dev/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/eagle-lake-dev/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
