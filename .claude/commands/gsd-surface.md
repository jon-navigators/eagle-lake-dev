...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/eagle-lake-dev/.claude/.gsd-surface.json`
(sibling to `/home/user/eagle-lake-dev/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/eagle-lake-dev/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/eagle-lake-dev/.claude/skills`).
...
`/home/user/eagle-lake-dev/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/eagle-lake-dev/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/eagle-lake-dev/.claude/.gsd-surface.json`
Install profile marker: `/home/user/eagle-lake-dev/.claude/.gsd-profile`
Skill dirs: `/home/user/eagle-lake-dev/.claude/skills/gsd-*/`
Engine module: `/home/user/eagle-lake-dev/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/eagle-lake-dev/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
