...
```markdown
Read /home/user/eagle-lake-dev/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/eagle-lake-dev/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/eagle-lake-dev/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/user/eagle-lake-dev/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/user/eagle-lake-dev/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/user/eagle-lake-dev/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/user/eagle-lake-dev/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
