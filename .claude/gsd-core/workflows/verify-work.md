...
<template>
@/home/user/eagle-lake-dev/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/user/eagle-lake-dev/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/user/eagle-lake-dev/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/user/eagle-lake-dev/.claude/gsd-core/workflows/diagnose-issues.md
