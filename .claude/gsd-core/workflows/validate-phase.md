...
```
Agent(
  prompt="Read /home/user/eagle-lake-dev/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/eagle-lake-dev/.claude/gsd-core/templates/VALIDATION.md`
