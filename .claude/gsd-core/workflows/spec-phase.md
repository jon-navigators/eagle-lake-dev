...
ones). Reference: @/home/user/eagle-lake-dev/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/eagle-lake-dev/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/eagle-lake-dev/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/eagle-lake-dev/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/eagle-lake-dev/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/eagle-lake-dev/.claude/gsd-core/templates/spec.md.
