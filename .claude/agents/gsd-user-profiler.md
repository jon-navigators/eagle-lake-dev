...
<reference>
@/home/user/eagle-lake-dev/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/eagle-lake-dev/.claude/gsd-core/references/user-profiling.md` to load:
