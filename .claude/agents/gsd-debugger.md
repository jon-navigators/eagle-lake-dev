...
<required_reading>
@/home/user/eagle-lake-dev/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/eagle-lake-dev/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/eagle-lake-dev/.claude
                  → checks /home/user/eagle-lake-dev/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/eagle-lake-dev/.claude/gsd-core
                  → writes to /home/user/eagle-lake-dev/.claude/gsd-core/hooks/
...
@/home/user/eagle-lake-dev/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/eagle-lake-dev/.claude/gsd-core/references/common-bug-patterns.md
