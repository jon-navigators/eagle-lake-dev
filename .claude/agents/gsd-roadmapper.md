...
Reference full template: `/home/user/eagle-lake-dev/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/eagle-lake-dev/.claude/gsd-core/templates/state.md`.
